...
class THttpServer(TServer.TServer):
    ...
    def __init__(self,
                 ...
                 inputProtocolFactory: Any,
                 outputProtocolFactory: Any | None = None,
        ...
        * key_file  - the server's key
        ...
        if (kwargs.get('cafile') or kwargs.get('cert_file') or kwargs.get('key_file')):
            ...
            if cert_file is None:
                raise ValueError("cert_file is required when enabling TLS")
            context.load_cert_chain(cert_file, kwargs.get('key_file'))
