...
class TServer(object):
    ...
    def __initArgs__(self, processor: Any, serverTransport: Any,
                     inputTransportFactory: Any, outputTransportFactory: Any,
                     inputProtocolFactory: Any, outputProtocolFactory: Any) -> None:
...
class TThreadPoolServer(TServer):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        TServer.__init__(self, *args)
        self.clients: queue.Queue[Any] = queue.Queue()
        self.threads: int = 10
        self.daemon = kwargs.get("daemon", False)
    ...
    def serveClient(self, client: Any) -> None:
