...
class TJSONProtocolBase(TProtocolBase):
    ...
    @property
    def string_length_limit(senf) -> int | None:
        return None

    @property
    def container_length_limit(senf) -> int | None:
        return None
    ...
    def writeUuid(self, uuid_val: UUID) -> None:
        self.writeJSONString(str(uuid_val))

    def readUuid(self) -> UUID:
        return UUID(self.readJSONString(False))
...
class TJSONProtocolFactory(TProtocolFactory):
    def getProtocol(self, trans: Any) -> TJSONProtocol:
...
class TSimpleJSONProtocolFactory(TProtocolFactory):
    ...
    def getProtocol(self, trans: Any) -> TSimpleJSONProtocol:
