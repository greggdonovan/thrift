...
def writeVarint(trans: TTransportBase, n: int) -> None:
...
class TCompactProtocol(TProtocolBase):
    ...
    def __init__(self, trans: TTransportBase,
                 string_length_limit: int | None = None,
                 container_length_limit: int | None = None) -> None:
    ...
    def writeBool(self, bool_val: bool) -> None:
        if self.state == BOOL_WRITE:
            ...
            assert self.__bool_fid is not None
    ...
    def __readSize(self) -> int:
        ...
        if result < 0:
            raise TProtocolException(message="Length < 0")
        return result
...
class TCompactProtocolAccelerated(TCompactProtocol):
    ...
    def __init__(self, trans: TTransportBase,
        ...
        super(TCompactProtocolAccelerated, self).__init__(
            trans,
