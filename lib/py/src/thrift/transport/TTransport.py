...
from typing import Any, BinaryIO, Final, Protocol, TypeAlias
...
class TTransportException(TException):
    ...
    UNKNOWN: Final[int] = 0
    NOT_OPEN: Final[int] = 1
    ALREADY_OPEN: Final[int] = 2
    TIMED_OUT: Final[int] = 3
    END_OF_FILE: Final[int] = 4
    NEGATIVE_SIZE: Final[int] = 5
    SIZE_LIMIT: Final[int] = 6
    INVALID_CLIENT_TYPE: Final[int] = 7

    def __init__(self, type: int = UNKNOWN, message: str | None = None, inner: Exception | None = None) -> None:
...
class TSaslClientTransport(TTransportBase, CReadableTransport):
    ...
    BAD: Final[int] = 3
    ERROR: Final[int] = 4
    COMPLETE: Final[int] = 5

    def __init__(self, transport: TTransportBase, host: str, service: str, mechanism: str = 'GSSAPI',
                 **sasl_kwargs: Any) -> None:
        """
        ...
        self.sasl: _SaslClient = SASLClient(host, service, mechanism, **sasl_kwargs)
    ...
    def open(self) -> None:
        ...
        self.send_sasl_msg(self.START, self.sasl.mechanism.encode("ascii"))
    ...
    def recv_sasl_msg(self) -> tuple[int, bytes]:
