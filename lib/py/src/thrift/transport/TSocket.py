...
from .TTransport import ReadableBuffer, TTransportBase, TTransportException, TServerTransportBase
...
class TSocket(TSocketBase):
    ...
    def __init__(self, host: str = 'localhost', port: int = 9090, unix_socket: str | None = None,
                 socket_family: int = socket.AF_UNSPEC,
                 socket_keepalive: bool = False) -> None:
    ...
    def _do_open(self, family: int, socktype: int) -> socket.socket:
...
class TServerSocket(TSocketBase, TServerTransportBase):
    ...
    def __init__(self, host: str | None = None, port: int = 9090, unix_socket: str | None = None,
                 socket_family: int = socket.AF_UNSPEC) -> None:
        self.host = host
        self.port = port
        self._unix_socket = unix_socket
        self._socket_family = socket_family
        self.handle = None
        self._backlog: int = 128
